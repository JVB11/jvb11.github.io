...
<div class="col-sm-6 clearfix">
  <div class="well">
    ...
    <img src="{{ base_path }}/images/publication_highlights/{{ publi.image }}" class="img-responsive" max-width="75%" max-height="20px" height="auto" style="padding: inherit; margin: auto; float: right;" />
