...
It assumes certain widely used simplifications (for example, spherical symmetry) to be able to simulate how a star evolves from its birth to its death. [<img src="/images/software/user/mesa-logo.png" style="width:40%; height:auto; margin-right:5%; margin-left:5%; float:right; display:block;">](https://docs.mesastar.org/en/stable/)
...
[<img src="/images/software/user/gyre-logo.png" style="width:40%; height:auto; margin-left:5%; margin-right:5%; float:left; display:block;">](https://gyre.readthedocs.io/en/stable/)[GYRE](https://gyre.readthedocs.io/en/stable/) can simulate non-interacting (linear) waves. 
