...
> Asteroseismic analyses of variable stars are mostly performed in a linear setting (see e.g., [Aerts 2021](https://journals.aps.org/rmp/abstract/10.1103/RevModPhys.93.015001)), in which mode frequencies/periods and their patterns are the primary observables to constrain stellar structure and evolution models.
...
Non-stationary amplitudes could be simulated using the amplitude equations derived in our framework.
...
<figure style="display:table; float:left; margin-right:6%; width:47%;">
  ...
  <figcaption style="display: table-caption; caption-side: bottom;">Schematic overview of triads of interacting oscillation modes. Orange circles indicate oscillation modes that naturally occur (i.e., are linearly driven) within the stellar model. Purple squares indicate oscillation modes that would not be sustained (i.e., are linearly damped) within the star without non-linear energy exchange among the modes in the triad.</figcaption>
</figure>
...
Any improvements in the description of opacity in the stellar interior will affect linear excitation properties of oscillation modes, which also is translated in the non-linear coupling properties and corresponding transport of angular momentum.
